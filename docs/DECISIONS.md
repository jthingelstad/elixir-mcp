...
- **The consumer taxonomy never shapes the domain** — surfaces (agents, the console, mail, the family's verticals) pull from the hub; a surface's needs never add a domain concept (from CONSUMER-SURFACES, archived 2026-09-25). (2026-09-19; Jamie)
