...
> **ARCHIVED — a snapshot, not a standing document.** This is the database as
> it looked on 2026-09-04, during the archive backfill: ~35k battles against
> ~50k today, and a projector that was then 93–94% of ingest cost. The NUMBERS
> are stale by construction. Kept for the method — how the schema-vs-usage
> review and the phase-timing census were done — because the next audit should
> be run the same way rather than invented again.
