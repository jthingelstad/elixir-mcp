...
function instructionsFor(kind, identity) {
  const conventions = [
    ...
    "| collection}; name a population, the corpus is never a default, and an",
    "omitted segment answers the corpus with a note and a population block.",
    ...
    "response echoes applied.window with source argument, default,",
    "unbounded, fixed or season (the meta tools default to the season).",
    "verbosity: 'compact' is the one size control. Every",
