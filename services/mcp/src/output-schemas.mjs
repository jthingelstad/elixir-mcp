...
export const OUTPUT_SCHEMAS = {
  ...
  battles_cards: {
    ...
    properties: {
      ...
      docs: DOCS,
      meta: META,
      modes_in_window: { type: "object" },
      notes: NOTES,
      player_tag: { type: ["string", "null"] },
    },
    required: [
      "applied",
      "cards",
    ...
    properties: {
      ...
      players: {
        ...
        items: {
          type: "object",
          properties: {
            battle_count: { type: ["number", "null"] },
            collection_level: { type: ["number", "null"] },
            donations: { type: ["number", "null"] },
            name: { type: ["string", "null"] },
            player_tag: { type: ["string", "null"] },
            trophies: { type: ["number", "null"] },
            window: { type: "object" },
          },
        },
      },
    },
    required: ["applied", "docs", "meta", "notes", "players"],
  },
  ...
  battles_opponents: {
    ...
    properties: {
      applied: { type: "object" },
      distinct_opponents: { type: ["number", "null"] },
      docs: DOCS,
      matching_opponents: { type: ["number", "null"] },
      meta: META,
      notes: NOTES,
      opponents: {
        type: "array",
        items: {
          ...
          properties: {
            battles: { type: ["number", "null"] },
            clan_tag_last_seen: { type: ["string", "null"] },
  ...
  battles_trends: {
      ...
      weeks: {
        ...
        items: {
          ...
          properties: {
            battles: { type: ["number", "null"] },
            covers: { type: "object" },
            iso_week: { type: ["string", "null"] },
            losses: { type: ["number", "null"] },
            modes: { type: "object" },
            net_trophies: { type: ["number", "null"] },
            partial: { type: ["boolean", "null"] },
            players: { type: ["number", "null"] },
            season_month: { type: ["string", "null"] },
            trophy_battles: { type: ["number", "null"] },
            trophy_mode_battles: { type: ["number", "null"] },
    ...
    required: ["applied", "docs", "meta", "notes", "weeks"],
  },
      ...
      cards: {
        ...
        items: {
          ...
          properties: {
            ...
            maxLevelRarityScale: { type: ["number", "null"] },
            name: { type: ["string", "null"] },
    ...
    properties: {
      ...
      entries: {
        ...
        items: {
          type: "object",
          properties: {
            breaking: { type: ["string", "null"] },
            date: { type: ["string", "null"] },
            summary: { type: ["string", "null"] },
            tools_added: { type: "array" },
  ...
  elixir_collectors: {
    ...
    required: ["collectors", "docs", "meta", "notes"],
  },

  elixir_data_insights: {
    type: "object",
    properties: {
      active_recordings: { type: "object" },
      api_observations: { type: ["number", "null"] },
      battles: { type: "object" },
      daily_snapshots: { type: ["number", "null"] },
      docs: DOCS,
      meta: META,
      notes: NOTES,
      players_observed: { type: ["number", "null"] },
      ...
      recorded_players: { type: "object" },
      war_weeks: { type: ["number", "null"] },
    },
    required: [
      "active_recordings",
      "api_observations",
      ...
      matches: {
        ...
        items: {
          ...
          properties: {
            ...
            in_section: { type: ["string", "null"] },
            section: { type: ["string", "null"] },
            slug: { type: ["string", "null"] },
            title: { type: ["string", "null"] },
            words_matched: { type: ["number", "null"] },
          },
        },
      },
      meta: META,
  ...
  game_clock: {
    ...
    properties: {
      applied: { type: "object" },
      as_of: { type: ["string", "null"] },
      day_ends_at: { type: ["string", "null"] },
      day_kind: { type: ["string", "null"] },
      day_started_at: { type: ["string", "null"] },
      docs: DOCS,
      meta: META,
      next_training_starts_at: { type: ["string", "null"] },
      next_war_day_opens_at: { type: ["string", "null"] },
      notes: NOTES,
      period_index: { type: ["number", "null"] },
      season_ends_at: { type: ["string", "null"] },
      season_id: { type: ["number", "null"] },
      season_month: { type: ["string", "null"] },
      season_started_at: { type: ["string", "null"] },
      ...
      events: {
        ...
        items: {
          ...
          properties: {
            ...
            game_days_seen: { type: "array" },
            last_seen_at: { type: ["string", "null"] },
            running_on_latest_day: { type: ["boolean", "null"] },
            title: { type: ["string", "null"] },
          },
        },
      },
      first_sighting_day: { type: ["string", "null"] },
      latest_sighting_day: { type: ["string", "null"] },
      meta: META,
      notes: NOTES,
    },
    required: [
  ...
  players_names: {
    ...
    required: ["applied", "docs", "meta", "names", "notes", "unknown"],
  },
  ...
  war_rivals: {
      ...
      rivals: {
        ...
        items: {
          ...
          properties: {
            ...
            finished_races: { type: ["number", "null"] },
            first_season: { type: ["number", "null"] },
            last_season: { type: ["number", "null"] },
            max_fame: { type: ["number", "null"] },
            mean_fame: { type: ["number", "null"] },
            median_fame: { type: ["number", "null"] },
            name: { type: ["string", "null"] },
    ...
    required: ["applied", "clan_tag", "docs", "meta", "notes", "rivals"],
  },
