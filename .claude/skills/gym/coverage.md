...
| battles | **PARKED, needs Jamie** (3 rounds, none clean; every finding shipped through 6.36.5) | 6.36.4 | 2026-09-23 | 3 | reports/2026-09-23-battles-r3.md | r3: #186-#189 done, #190 praise; all r1/r2 + 31 legacy regressions hold except #148 (finished as #187). trail stays casual in the type fold (the tag is the rule; a fold change trips meta_season_pop CHECK); outside_meta on segment reads only. Question: round 4? |
