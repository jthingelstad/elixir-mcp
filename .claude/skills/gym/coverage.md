...
| game | **CLEAN r5 (7.1.19)** | 7.1.19 | 2026-09-24 | 5 | reports/2026-09-24-game-r5.md | r5: 14/14 regressions CONFIRMED FIXED incl. #296-#298; 126.5 confirmed (day 09-24 read 10:07:54Z, grid pin working); #310 praise (10 controls). Open: season read's first/last_seen_at span the whole record; latest_sighting_day undescribed |
...
| war | r4 fixed (7.1.20); not clean (2 wording findings) | 7.1.19 | 2026-09-24 | 4 | reports/2026-09-24-war-r4.md | r4 on LIVE war day 1: 25/25 regressions hold (#226 exact vs day logs; #306 13/13); #311 glossary/war docs, #312 two participants counts; #313 praise. Open: attendance vs recorded battles when the race poll refreshes; 129/1 reads 10,000 with no day log |
