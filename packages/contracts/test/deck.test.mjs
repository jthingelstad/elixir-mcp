...
test("hash is order-independent", () => {
  const a = {
    cards: cards(26000000, 26000001, 28000000),
    towerTroopId: 159000000,
  };
  const b = {
    cards: cards(28000000, 26000000, 26000001),
    towerTroopId: 159000000,
  };
...
test("evolution form is part of identity — forms never merge", () => {
  ...
  const evo = {
    cards: [{ id: 26000000, evolutionLevel: 1 }, { id: 26000001 }],
  };
  const hero = {
    cards: [{ id: 26000000, evolutionLevel: 2 }, { id: 26000001 }],
  };
